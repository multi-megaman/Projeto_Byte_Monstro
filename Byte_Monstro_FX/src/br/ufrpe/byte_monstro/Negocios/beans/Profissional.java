...
public class Profissional extends UsuarioGeral implements Serializable {
    ...
    private EnumAcademia unidadeAtual;
    private ArrayList<Aluno> alunosVinculados;

    public Profissional(long id, String nome, int idade, char genero, double peso, double altura, double percentualGordura, String senha, EnumAcademia unidadeAtual) {
    ...
    public EnumAcademia getUnidadeAtual() {
        return unidadeAtual;
    }

    public void setUnidadeAtual(EnumAcademia unidadeAtual) {
        this.unidadeAtual = unidadeAtual;
    }
